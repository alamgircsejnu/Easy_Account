...
<div style="width: 100px;background-color:#2b669a;margin-left: 348px;height: 30px ">
    <a style="margin: 5%;padding: 5%" href="edit.php?id=<?php echo $oneSupplier['id'] ?>"> <img style="margin: 3%"
                                                                                                border="0"
                                                                                                title="Edit Supplier Info"
                                                                                                alt="Edit"
                                                                                                src="../../../../asset/images/edit.png"
                                                                                                width="25" height="20"></a>
    <a style="margin: 5%;padding: 5%" href="trash.php?id=<?php echo $oneSupplier['id'] ?>"
       onclick="return confirm('Are you sure?')"> <img style="margin: 3%" border="0" title="Delete This Supplier"
