...
//    die();
        ...
        if ($taskYear==$currentYear){
            ...
            $newTaskId = 'OF'.$taskYear.$newTaskNumber;
//echo $first;
//echo '<br>';
//echo $newTaskId;
//die();
            ...
            $newTaskNumber = '1001';
            $newTaskId = 'OF'.date('Y').$newTaskNumber;
        }
    } else{
        $newTaskNumber = '1001';
        $newTaskId = 'OF'.date('Y').$newTaskNumber;
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary custom-panel">
                ...
                <form role="form" action="store.php" method="post">
                    <p style="font-size: 14px;color: #419641;margin-left: 335px">Monthly Total Offer: <?php if (empty($totalAmount['total_amount'])){echo '<span style="color: #0000FF">0 BDT</span>';} else {echo '  <span style="color: #0000FF"> '.$totalAmount['total_amount'].' BDT </span>';}?></p>
                    ...
                    <div>
                        <div class="col-md-6">
                            ...
                            <input type="text" id="offerId" name="offerId" class="form-control custom-input"
                                   value="<?php echo $newTaskId ?>"  placeholder="Offer Code" required readonly>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="customerName" class="form-control col-sm-6 custom-input" id="customerName">
                                ...
                                if (isset($allCustomers) && !empty($allCustomers)) {
                                    foreach ($allCustomers as $oneCustomer) {
                                        ?>
                                        <option><?php echo $oneCustomer['customer_name']?></option>
                                    <?php }}  ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                    ...
                    <br><br><br>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="offerDate" name="offerDate" class="form-control custom-input"
                                   value="<?php echo date('Y-m-d')?>"  placeholder="Offer Date">
                        </div>
                    <br><br><br>
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div>
                                <div class="col-md-4" style="float: right;width: 4%;margin-top: 11px;margin-right: 17px">
                                    <button type="submit" class="btn btn-info pull-right">Create Offer</button>
                                </div>
                            </div>
                        </div>
                    </div>
