                    ...
                    <?php }  ?>
                        ...
                        <li class="dropdown-submenu"><a tabindex="-1" href="#">Manual Attendance</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="../../../BasicEntry/Attendense/AttendenseEntry/index.php">Your Pending Attendance</a></li>
                                <li><a href="../../../BasicEntry/Attendense/AttendenseEntry/approvedAttendense.php">Your Approved Attendance</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu"><a tabindex="-1" href="#">Expenses</a>
                            <ul class="dropdown-menu">
                                <li><a tabindex="-1" href="../../../Operation/Expense/EnterExpense/pendingExpense.php">Approve Expense</a></li>
                                <li><a href="../../../Operation/Expense/EnterExpense/approvedExpenses.php">Approved Expenses</a></li>
