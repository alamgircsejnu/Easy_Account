            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td width="130">
                        ...
                        <a href="edit.php?id=<?php echo $onePayment['id'] ?>"> <img style="margin: 3%" border="0"
                                                                                                   title="Edit" alt="Edit"
                                                                                                   src="../../../../asset/images/edit.png"
                                                                                                   width="25" height="20"></a>
                        <a href="trash.php?id=<?php echo $onePayment['id'] ?>" onclick="return confirm('Are you sure?')">
